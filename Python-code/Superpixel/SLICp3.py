#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2018-04-05 9:08:01
# @Author  : wjm (wjmecho@foxmail.com)
# @Link    : 
# @Version : $Id$
...
class SLIC:
    ...
    def _initData(self):
        ...
        for i in range(int(self.step), int(self.width - self.step/2), int(self.step)):
            for j in range(int(self.step), int(self.width - self.step/2), int(self.step)):
